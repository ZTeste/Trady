"""
.. moduleauthor:: Granqvist
.. https://github.com/grananqvist
...
if __name__ == "__main__":
    ...
    parser.add_argument('-t', '--token',
                        help='Your FXCM API token to authorize for access. Works with a demo account key', default=None)
    parser.add_argument('-s', '--symbol', nargs='+',
                        help='symbols to download. Flag can be used to download multiple symbols. Example: -s EUR/USD AUD/USD. Downloads all symbols by default',
                        default=None)
    parser.add_argument('-pe', '--period',
                        help='Time frame for data to download. m1, m5, m15, m30, H1, H2, H3, H4, H6, H8, D1, W1, M1',
                        default='m1')
